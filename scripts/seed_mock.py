...
def criar_mock():
    ...
    try:
        ...
        s_alin = ServicoModel(
            ...
            preco_base=Decimal("120.00"),
            tempo_estimado_minutos=45,
        )
        s_freo = ServicoModel(
            id=uuid4(),
            nome="Revisao de freios",
            descricao="Inspecao completa do sistema de freios",
        ...
        s_diag = ServicoModel(
            ...
            descricao="Leitura de codigos de erro via scanner",
        ...
        s_filt = ServicoModel(
            ...
            descricao="Troca de filtro de ar e combustivel",
            preco_base=Decimal("90.00"),
            tempo_estimado_minutos=30,
        )
        s_pneu = ServicoModel(
            id=uuid4(),
            nome="Troca de pneu",
            descricao="Troca e calibragem de pneu",
            preco_base=Decimal("80.00"),
            tempo_estimado_minutos=20,
        )
        s_susp = ServicoModel(
            id=uuid4(),
            nome="Revisao de suspensao",
            descricao="Verificacao completa da suspensao",
        ...
        s_elet = ServicoModel(
            ...
            descricao="Verificacao do sistema eletrico",
            preco_base=Decimal("160.00"),
            tempo_estimado_minutos=45,
        )
        ...
        o1 = nova_os(
            c1,
            v1,
            "Revisao periodica — troca de oleo",
            StatusOS.ENTREGUE,
            Decimal("325.00"),
            ha(120),
            ha(118),
        ...
        item_s(
            o4, s_alin, "Alinhamento e balanceamento", Decimal("120.00"), True, ha(74)
        )

        o5 = nova_os(
            c1,
            v1,
            "Pneu furado e desgaste irregular",
            StatusOS.ENTREGUE,
            Decimal("520.00"),
            ha(60),
            ha(59),
        ...
        item_s(
            o5, s_alin, "Alinhamento e balanceamento", Decimal("120.00"), True, ha(59)
        )
        ...
        item_s(
            o8, s_alin, "Alinhamento e balanceamento", Decimal("120.00"), True, ha(19)
        )

        o9 = nova_os(
            c2,
            v3,
            "Correia dentada — risco de ruptura",
            StatusOS.ENTREGUE,
            Decimal("435.00"),
            ha(15),
            ha(13),
        ...
        item_s(
            o10, s_alin, "Alinhamento e balanceamento", Decimal("120.00"), True, ha(7)
        )
        ...
        o14 = nova_os(
            c2,
            v3,
            "Todos servicos prontos aguardando vistoria",
        ...
        item_s(
            o14, s_alin, "Alinhamento e balanceamento", Decimal("120.00"), True, ha(0)
        )

        o15 = nova_os(
            c4,
            v6,
            "Revisao completa 100k km",
            StatusOS.SERVICOS_CONCLUIDOS,
            Decimal("610.00"),
            ha(3),
            ha(0),
        ...
        item_s(
            o16, s_alin, "Alinhamento e balanceamento", Decimal("120.00"), False, None
        )

        o17 = nova_os(
            c1,
            v1,
            "Revisao pre-viagem longa",
            StatusOS.EM_EXECUCAO,
            Decimal("420.00"),
            ha(1),
            ha(0),
        ...
        item_s(
            o17, s_alin, "Alinhamento e balanceamento", Decimal("120.00"), False, None
        )
        ...
        _o25 = nova_os(
            c4, v6, "Barulho ao acelerar", StatusOS.EM_DIAGNOSTICO, None, ha(0), ha(0)
        )
        ...
        _o27 = nova_os(
            c3, v5, "Revisao periodica 80k km", StatusOS.RECEBIDA, None, ha(0), ha(0)
        )

        _o28 = nova_os(
            c5, v8, "Carro trepidando ao frear", StatusOS.RECEBIDA, None, ha(0), ha(0)
        )
        ...
        o29 = nova_os(
            c1,
            v2,
            "Diagnostico — cliente recusou orcamento alto",
            StatusOS.CANCELADA,
            Decimal("200.00"),
            ha(50),
            ha(48),
        ...
        o30 = nova_os(
            c2,
            v3,
            "Revisao completa — orcamento recusado",
            StatusOS.CANCELADA,
            Decimal("890.00"),
            ha(35),
            ha(33),
        ...
        o31 = nova_os(
            c4,
            v7,
            "Troca de correia — cancelado por preco",
            StatusOS.CANCELADA,
            Decimal("455.00"),
            ha(20),
            ha(19),
        ...
        print(
            f"Mock criado: 5 clientes | 8 veiculos | 8 servicos | 8 pecas | {total} OS"
        )
